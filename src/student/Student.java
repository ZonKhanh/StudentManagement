...
public class Student {
    ...
    public void delete(int id) {
        int yesOrNo = JOptionPane.showConfirmDialog(null, "course and score records also be deleted", "Student deleted", JOptionPane.OK_CANCEL_OPTION, 0);
